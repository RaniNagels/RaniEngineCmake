...
{
	m_AnimationInfo = ResourceManager::GetInstance().GetResource<AnimationInfo>(m_Descriptor.dataResourceFile, m_Descriptor.animationKey);
	...
	for (auto frame : m_AnimationInfo->frameKeys)
		m_Frames.emplace_back(m_pSpriteRenderComponent->RequestFrameInfo(m_Descriptor.dataResourceFile, frame));
